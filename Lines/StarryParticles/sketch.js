 ...
 // clear();
  ...
  for (var y = 0; y < rows; y++) {
    for (var x = 0; x < cols; x++) {
      ...
      flowField[index].pos = rotate_point(200, 200, 0.0001, flowField[index].pos);


      var v = createVector( (200 - (flowField[index].pos.x)) * vectorForceScale, (200 - (flowField[index].pos.y)) * vectorForceScale);
      v.setMag(0.7);
      flowField[index].vec = v;
